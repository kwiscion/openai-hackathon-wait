...
async def extract_text_from_image(image, model, semaphore):
    ...
    async with semaphore:
        ...
        messages = [
            SystemMessage(
                content="""You are an expert at extracting text from images.
...
async def get_text_from_pdf_with_vision(
    pdf_path: str = None, pdf_bytes: bytes = None, max_concurrent: int = 3
) -> str:
    """
